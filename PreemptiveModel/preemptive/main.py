...
for i in range(ITER_LIMIT):
    ...
    zd  = lr.sol_sub1() + lr.sol_sub2() + lr.sol_sub3() + lr.sol_sub4() + lr.sol_sub5() + lr.sol_sub6_1() + lr.sol_sub6_2() + lr.sol_sub7() + lr.sol_sub8() + lr.sol_sub9() + lr.sol_sub10() + lr.sol_sub11() + lr.constant_value()     
    ...
    primal_all_value = primal.all_value()
